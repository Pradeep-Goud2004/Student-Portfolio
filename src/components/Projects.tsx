...
const projects = [
  {
    ...
    description: 'A feature-rich scientific calculator with advanced mathematical functions, history tracking, and responsive design.',
  ...
  {
    title: 'Physical Fitness & Wellness Tracking',
    description: 'Comprehensive fitness tracking system for monitoring workouts, nutrition, health metrics, and wellness goals.',
  ...
  },
  {
    ...
    description: 'Digital whiteboard with real-time collaboration features, drawing tools, and multi-user support for remote teams.',
  ...
  {
    title: 'Online Book Booking System',
    description: 'Library management system for browsing, reserving, and managing book borrowings with user authentication.',
